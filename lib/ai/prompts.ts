...
export const PERSONAS: Persona[] = [
  {
    ...
    traits: 'Direct, analytical, asks tough questions about market size and defensibility',
  ...
  },
  {
    ...
    traits: 'Passionate about technology, thinks in terms of product-market fit',
...
export const SCENARIOS: Scenario[] = [
  {
    ...
    context: 'You are at a major AI conference in San Francisco. You bump into someone during a coffee break.',
  },
  {
    id: 'ai-trends',
    name: 'AI Trends Discussion',
    nameChinese: 'AI 趋势讨论',
    description: 'Discuss the latest developments in AI, AGI timelines, and industry impact',
    context: 'You are having a deep conversation about where AI is heading in the next 2-3 years.',
  },
  {
    id: 'business',
    name: 'Business & Startup Exchange',
    nameChinese: '商业交流',
    description: 'Discuss business models, market opportunities, and China-US differences',
    context: 'You are exploring potential collaborations or sharing insights about the creator economy.',
  },
  {
    id: 'small-talk',
    ...
    context: 'You are at a casual dinner with tech professionals. The conversation is light and social.',
  },
  {
    id: 'interview',
    name: 'Interview / Podcast',
    nameChinese: '采访 / 播客',
    description: 'Being interviewed about your work, AI views, and content creation',
    context: 'You are being interviewed for a tech podcast about AI content creation in China.',
  },
];

export function buildConversationSystemPrompt(persona: Persona, scenario: Scenario): string {
...
1. **Vocabulary**: Professional/advanced words and phrases (B2+ level). Skip common words. For each:
...
3. **Key Phrases**: Notable collocations, idioms, or expressions worth learning
